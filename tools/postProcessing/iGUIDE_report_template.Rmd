...
tbl_algn_counts <- input_data$algnmts %>%
  group_by(specimen) %>%
  summarise(reads = sum(count), fragments = n())
...
kable(
    spec_overview, format = "latex", booktabs = TRUE, caption = "Specimen summary.", 
    align = "c", digits = 1, longtable = TRUE, 
