...
null <- lapply(seq_along(ft_seqs_list), function(i){
  ...
  cat(paste0("**Table ", i+5, ". Off-Target Loci: ", names(ft_seqs_list)[i], "**"))
  ...
  pander::pandoc.table.return(
      t = df,
      style = "simple",
      emphasize.verbatim.cols = 6,
      justify = c(rep("centre", 3), "right", "right", "centre", "centre")
    ) %>%
    cat()
