...
parser$add_argument(
  "stats", nargs = 2, type = "character", required = TRUE,
  help = paste(
    "Stat objects generated by iGUIDE run command. Input order: core, eval.",
    "Requires csv format."
  )
)
...
parser$add_argument(
  "-i", "--iguide_dir", nargs = 1, type = "character", default = "IGUIDE_DIR",
...
# Check input file ----
core_file <- args$stats[1]
eval_file <- args$stats[2]
